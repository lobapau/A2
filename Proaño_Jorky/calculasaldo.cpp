...
int main  ()
{
	...
	/cout nos ayude imprimir por pantalla todos lo que vamos a escribir dentro de las comillas e ingresaremos 	*JAPP_l:/
...
/La instrucción do-while permite repetir una instrucción o una instrucción compuesta hasta que una expresión especificada sea false/
	...
	a lo que usuario debe ingresar, en este caso ingresaremos JAPP_x*
		cin>>JAPP_x;
